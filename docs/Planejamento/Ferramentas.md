...
|         ![Draw.io](../img/draw-io.webp){ width="120" }         |                                               [Draw.io](https://app.diagrams.net/)                                                | Elaboração das Rich Pictures  |
...
|          ![Gemini](../img/unnamed.png){ width="110" }           |                                         [Miro](https://miro.com/app/dashboard/)                                          |  Elaboração da Matriz CSD     | 
...
| ------ | ---------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| 1.0    | 01/06/2026 | Documentação do benchmarking      |  [Geovanna Alves](https://github.com/GeovannaUmbelino) | [Felipe Serikava](https://github.com/felipeserikava-web)  e [Ronan Freitas](https://github.com/HunterBRR)|
|
